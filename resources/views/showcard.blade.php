...
<body>
    ...
    <div id="top">
        <table align="center" bgcolor="gray">
            ...
            <form action="{{ url('orderconfirm') }}" method="post">
                ...
                @foreach ($data2 as $data2)
                    <tr style="position:relative; top:-60px; right:-350px;">
                        <td>
        ...
        <div align="center" style="paddin:20px;">
        ...
        <div id="appear" align="center" style="padding: 10px; display:none;">
            ...
            <div style="padding: 10px;">
                <input type="submit" value="Oreder Confirm" class="btn btn-success" style="color:black;">
